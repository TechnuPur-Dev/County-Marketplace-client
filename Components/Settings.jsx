                ...
                <div className=" form-control">
                  <div className="row ">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">
                      ...
                      <input className=" font-sm" type="text" value="Full Name *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">

                      <input className=" font-sm" type="text" name="full_name" value={info?.full_name} onChange={handleChange} placeholder="Fullname *" style={{ color: '#B2C2E1', border: 'none', borderBottom: '1px solid #ced4da', textAlign: 'center' }} />
                ...
                <div className=" form-control">
                  <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">
                      ...
                      <select name="gender" id="cars" value={info?.gender} onChange={handleChange} style={{ padding: '3px 45px', color: '#B2C2E1', border: 'none', borderBottom: '1px solid #ced4da', textAlign: 'center' }}>
              ...
              <div className="col-lg-12 mb-3">
                <div className=" form-control">
                  <div className="row ">
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">
                      <input className=" font-sm" type="date" placeholder="Contact *" onChange={handleChange} name="birthday" value={info?.birthday} data-date-format="yyyy mm dd" style={{ padding: '3px 16px', color: '#B2C2E1', border: 'none', borderBottom: '1px solid #ced4da', textAlign: 'center' }} />
                ...
                <div className=" form-control">
                  <div className="row ">
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">
                      ...
                      <input className=" font-sm" type="text" value="Contact No *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-6 col-5">

                      <input className=" font-sm" type="text" name="contact_no" onChange={handleChange} placeholder="Contact *" value={info?.contact_no} style={{ color: '#B2C2E1', border: 'none', borderBottom: '1px solid #ced4da', textAlign: 'center' }} />
              ...
              <div className="form-control">
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-3 col-sm-3 col-3">
                    ...
                    <input className=" font-sm" type="text" value="Name *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                  </div>
              ...
              <div className="form-control">
                <div className="row">
                  ...
                  <div className="col-lg-6 col-md-6 col-sm-6 col-5">
                    ...
                    <input className=" font-sm" type="text" value="Default Address *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                  </div>
                  <div className="col-lg-6 col-md-6 col-sm-6 col-5">
            ...
            <div className=" form-control">
              <div className="row ">
                <div className="col-lg-4 col-md-4 col-sm-4 col-4">
                  ...
                  <input className=" font-sm" type="text" value="Address 1 *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                </div>
            ...
            <div className=" form-control">
              <div className="row ">
                <div className="col-lg-4 col-md-4 col-sm-4 col-4">
                  ...
                  <input className=" font-sm" type="text" value="Address 2 *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                </div>
                <div className="col-lg-8 col-md-8 col-sm-8 col-8">
              ...
              <div className="form-control">
                <div className="row">
                  ...
                  <div className="col-lg-3 col-md-3 col-sm-3 col-3">
                    ...
                    <input className=" font-sm" type="text" value="City *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                  </div>
                  <div className="col-lg-9 col-md-9 col-sm-9 col-9">
              ...
              <div className="form-control">
                <div className="row">
                  <div className="col-lg-3 col-md-3 col-sm-3 col-3">
                    ...
                    <input className=" font-sm" type="text" value="State *" style={{ border: 'none', color: '#B2C2E1' }} readonly="readonly" />
                  </div>
